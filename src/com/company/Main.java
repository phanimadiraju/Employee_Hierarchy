...
public class Main {
	...
	// Employee Hierarchy
        ...
        Developer developer3=new Developer("hareesh",1704,"Associate Software Engineer","Digital");
        Manager manager=new Manager("Umakanth",1500,"Team manager","Digital",3,"Bangalore");
        President president=new President("Sanjay kommera",530,"President","Digital",50,"OnSite","Digital Platforms");
